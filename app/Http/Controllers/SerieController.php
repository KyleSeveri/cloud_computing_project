...
class SerieController extends Controller
{
    public function index(){
        $response =  Http::get('https://api.themoviedb.org/3/discover/tv?api_key=fb4817418d08c8e2729a3ffab3bf1b8a&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1',[
        ...
        return view('serie')->with("snack", $snack)
                            ->with("genre", $genre)
